...
const Info = () => {
  ...
  return (
    <div className="text-black">
      <h2 className="text-5xl md:text-5xl text-center mb-6 londrina font-bold">HOW TO BUY</h2>
      ...
      {/* Stack 1 */}
        ...
        <div class="relative col-span-1 w-full h-full flex justify-center items-center">
            <div class="h-full w-1 bg-indigo-300"></div>
            <div class="absolute w-6 h-6 rounded-full bg-black z-10 text-white  text-center">2</div>
        </div>
        <div class="col-span-4 w-full h-full ">
            <div class="w-full h-full p-2 md:pl-4">
                <h1 class="text-4xl font-semibold py-2 londrina">GET SOME SOL</h1>
                <p class="text-2xl">Buy some SOL from an exchange (Binance, Bybit...)</p>
            </div>
        </div>
        ...
        <div class="col-span-4 w-full h-full ">
            <div class="w-full h-full p-2 md:pl-4">
                ...
                <p class="text-2xl">Click BUY NOW, link your wallet to start swapping</p>
            </div>
        </div>
        <div class="relative col-span-1 w-full h-full flex justify-center items-center">
            <div class="h-full w-1 bg-indigo-300"></div>
     ...
     <div class="col-span-4 w-full h-full"></div>
        ...
        <div class="col-span-4 w-full h-full ">
            <div class="w-full h-full p-2 md:pl-4">
                ...
                <p class="text-2xl">Select the amount of $Neko you want to buy and swap!</p>
            </div>
        </div>
